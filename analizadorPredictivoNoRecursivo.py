...
def digitos():
	...
	if(re.search(r"[0-9]",preanalisis)):
		...
		reportar("Error de Sintaxis",preanalisis,"digitos")
...
def asignacionollamada():
	...
	if (preanalisis == ":="):
		...
		reportar("error de sintaxis",preanalisis,"asignacionollamada")
...
def expresionGeneral():
	...
	if(((re.search(r"[a-z]",preanalisis)) and (preanalisis not in palabrasReservadas)) or (re.search(r"[0-9]",preanalisis)) or preanalisis in caso1):
		...
		reportar("error de sintaxis",preanalisis,"expresionGeneral")
...
def ifthen():
	...
	if ( preanalisis == "if") :
			 ...
			 reportar("error de sintaxis",preanalisis,"ifthen")
...
def ifthen1():
	...
	if ( preanalisis == "begin") :
			 ...
			 reportar("error de sintaxis",preanalisis,"ifthen1")
...
def ifthen2():
	...
	if  (preanalisis == ";"):
			 ...
			 reportar("error de sintaxis",preanalisis,"ifthen2")
...
def alternativa():
	...
	if ( preanalisis == "else") :
			 ...
			 reportar("error de sintaxis",preanalisis,"alternativa")
def mientras():
	if(verbose):
		print("mientras")
	if ( preanalisis == "while") :
			 ...
			 reportar("error de sintaxis",preanalisis,"mientras")
...
def declaracionPyf():
	...
	if ( preanalisis == "procedure") :
			 ...
			 reportar("error de sintaxis",preanalisis,"declaracionPyf")
...
def llamadaProcedimiento():
	...
	if ( preanalisis == "write") :
			 ...
			 reportar("error de sintaxis",preanalisis,"llamadaProcedimiento")
...
def llamada1():
	...
	if ( preanalisis == ")") :
			 ...
			 reportar("error de sintaxis",preanalisis,"llamada1")
...
def reportar(tipoError,simbolo,metodo):
	print "ERROR DETECTADO: "+ tipoError+ " en el (los) caracter(es) "+ repr(preanalisis)+" despues de "+ tokens[posicion-1] +"\n"
	exit(0)
